...
describe "An existing user logs in to sheetstr and creates a timesheet", type: :feature do
  ...
  context "The user hasn't completed their onboarding" do
    scenario "a screen is shown to complete their onboarding" do
      When "They log in" do
        login_as(@ben)
      end
  ...
  context "The user has completed their onboarding" do
    before do
      create(:user_configuration, user: @ben, timezone_identifier: "Sydney")
    end
